...
//burda da dene adaptere yazdıgın kısmı.

        val filmlerAdapter= FilmlerAdapter(requireContext(),filmlerListesi) //Adaptera aktardık adapter düzenledi
        binding.filmlerRv.adapter=filmlerAdapter //recyclerview'a aktardı
